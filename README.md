...
For specs file ```recorded-data-example-1.txt```,  which is included in the examples folder, we can perform a variational annealing estimate with initial seed 3:
