...
See the src/models.generic_model_class example in the models module for an example of a parameter set dictionary.  With these parameters defined in the specs file, generate fake stimuli and measured data using (say, with specs file ```FRET-fake-est-1.txt```)
